...
#     return "(" & $entry.pair.key & ": " & $entry.pair.value & " @" & $entry.sparseIdx & ")"
# 
# proc dump[N : static int, K, V](m: StaticSparseMap[N, K, V], denseIdx: DenseIdx): string =
#     if denseIdx == UnusedDenseIdx:
#         return "unused"
#     elif denseIdx == TombstonedIdx:
#         return "tombstoned"
#     else:
#         return $(denseIdx.toUInt)
# 
# proc dumpInternals*[N : static int, K, V](m: StaticSparseMap[N, K, V]) =
#     echo "StaticSparseMap[", $N, ", ", $K, ", ", $V, "]"
#     echo "  Size=", m.size
#     echo "  Sparse Index:"
#     for i, denseIdx in m.sparse:
#         echo "    ", i, " = ", m.dump(denseIdx)
#     echo "  Dense Index:"
#     for i, entry in m.dense:
#         echo "    ", i, ": ", dump(entry)
# 
# proc `$`*[N : static int, K, V](m: var StaticSparseMap[N, K, V]): string =
#     result = "StaticSparseMap("
#     var i = 0
#     for entry in m:
#         if i > 0:
#             result &= ", "
