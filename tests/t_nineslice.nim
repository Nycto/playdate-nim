...
template assertNineSlice(
    nineSlice: NineSlice,
    width, height: int,
    expect: openarray[string],
    setMask: bool = true,
) =
...
proc execNineSliceTests*(runnable: bool) =
  suite "Nine Slice API":
    if runnable:
      ...
      let nineSlice27x3 =
        playdate.graphics.newBitmap("nineslice_27x3.png").newNineSlice()
      for width in 18 .. 30:
